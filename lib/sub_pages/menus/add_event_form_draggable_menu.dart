...
import 'package:akademi_etkinlik/pages/create/event_join.dart';
import 'package:akademi_etkinlik/pages/create/event_rate.dart';
        ...
        child: Column(
          children: [
            _tile(
              ...
              page: const CreateEventJoinPage(),
            ),
            _tile(
              context,
              icon: Icons.rate_review_outlined,
              title: "Değerlendirme Formu Oluştur",
              page: const CreateEventRatePage(),
            ),
          ],
        ),
      ),
